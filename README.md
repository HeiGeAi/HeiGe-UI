...
| <a href="https://heigeai.github.io/HeiGe-UI/examples/darktech-console.html"><img src="assets/previews/darktech-console.webp" width="400" alt="darktech-console" /></a> | **AI 原生 / 暗色科技** | Agent 编排控制台 HELM |
...
>
> 样例的展示字体走 Google Fonts CDN，且全部做了系统字体兜底，加载失败不崩。内网或严格 CSP 环境请把字体改为自托管。
